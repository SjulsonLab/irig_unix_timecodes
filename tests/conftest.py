...
Also provides a synthetic SpikeGLX nidq recording for shared use across
test_sglx.py and test_decoder.py.
"""
...
# -- SpikeGLX nidq fixture (shared by test_sglx.py and test_decoder.py) -------
